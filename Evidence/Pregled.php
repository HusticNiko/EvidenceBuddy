...
WHERE e.tk_uporabnik = '".$loggin_session."';";
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo "<td align='left'><form method='post' action='Pregled.php' ><input name='ID' hidden value=".$row['ID']."><input name='imeevidence' hidden value=".$row['imeevidence']."><input name='status_gradiva' hidden value=".$row['status_gradiva']."><input name='tk_uporabnik' hidden value=".$row['tk_uporabnik']."><button class='primary_btn' name='submit' type='submit'>Izbriši</button></form></td></tr>";
                                }
                                echo "</table></div>";
...
AND e.status_gradiva = 'IZPOSOJENO';";
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo "<td align='left'><form method='post' action='Pregled.php' ><input name='imeevidence' hidden value=".$row['imeevidence']."><input name='datum' hidden value=".$row['datum']."><input name='uporabnisko_ime' hidden value=".$row['uporabnisko_ime']."><button class='primary_btn' name='vrnitev' type='submit'>Vrnjeno</button></form></td></tr>";
                                }
                                echo "</table></div>";
